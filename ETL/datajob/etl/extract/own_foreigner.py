...
class OwnTransferByNationality:
    ...
    def extract_data(cls, before_cnt=1):
        for i in range(1, before_cnt + 1):
            ...
            log_dict = {
                "is_success": "Fail",
                "type": "ownership_transfer_by_nationality",
            ...
            try:
                ...
                file_name = 'ownership_by_nationality_' + params['search_start_date_api'] + '.json'
                ...
                get_logger('ownership_transfer_by_nationality').error(log_json)
